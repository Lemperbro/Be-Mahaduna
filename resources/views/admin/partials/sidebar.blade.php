        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('playlist.index') }}"
                    class="flex items-center p-2 text-gray-400 rounded-lg group hover:bg-SidebarActive {{ request()->routeIs('playlist.*') ? 'bg-SidebarActive' : '' }}">
            ...
            <li>
                <a href="{{ route('artikel.index') }}"
                    class="flex items-center p-2 text-gray-400 rounded-lg group hover:bg-SidebarActive {{ request()->routeIs('artikel.*') ? 'bg-SidebarActive' : '' }}">
            ...
            <li>
                <a href="{{ route('majalah.index') }}"
                    class="flex items-center p-2 text-gray-400 rounded-lg group hover:bg-SidebarActive {{ request()->routeIs('majalah.*') ? 'bg-SidebarActive' : '' }}">
            ...
            <li>
                <a href="{{ route('store.index') }}"
                    class="flex items-center p-2 text-gray-400 rounded-lg group hover:bg-SidebarActive {{ request()->routeIs('store.*') ? 'bg-SidebarActive' : '' }}">
            ...
            <li>
                <a href="{{ route('jadwal.index') }}"
                    class="flex items-center p-2 text-gray-400 rounded-lg group hover:bg-SidebarActive {{ request()->routeIs('jadwal.*') ? 'bg-SidebarActive' : '' }}">
            ...
            <li>
                <a href="{{ route('kelola-pembayaran.index') }}"
                    class="flex items-center p-2 text-gray-400 rounded-lg group hover:bg-SidebarActive {{ request()->routeIs('kelola-pembayaran.*') ? 'bg-SidebarActive' : '' }}">
            ...
            <li>
                <a href="{{ route('monitoring.sholat.index') }}" class="flex items-center p-2 text-gray-400 rounded-lg group hover:bg-SidebarActive {{ request()->routeIs('monitoring.sholat.*') || request()->is('monitoring/sholat/*') ? 'bg-SidebarActive' : '' }}">
            ...
            <li>
                <a href="{{ route('monitoring.ngaji.index') }}" class="flex items-center p-2 text-gray-400 rounded-lg group hover:bg-SidebarActive {{ request()->routeIs('monitoring.ngaji.*') || request()->is('monitoring/ngaji/*') ? 'bg-SidebarActive' : '' }}">
