<form class="w-full" action="{{ route('monitoring.ngaji.index') }}" method="GET">
...
@include('admin.Monitoring-Ngaji.modal-filter._modalTahunFilter')
@include('admin.Monitoring-Ngaji.modal-filter._modalJenjangFilter')