    ...
    <section>
        ...
        <div class="pt-24 min-h-screen">
            <div
                ...
                <a href="{{ route('monitoring.ngaji.index', http_build_query(array_merge(request()->all(), ['download' => true]))) }}" class="flex gap-2 items-center justify-center bg-green-600 py-1 px-4 rounded-md w-full sm:w-auto">
