...
<!-- Dropdown menu -->
<div id="dropdown{{ $key }}"
    class="z-10 hidden bg-white border rounded-lg shadow-md w-44 ">
    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
        ...
        <li>
                <button type="button" onclick="delete{{ $key }}.showModal()" class=" px-4 py-2 hover:bg-gray-100 w-full text-left text-red-800 flex gap-2 items-center">
                    <i class="ri-delete-bin-5-fill text-xl"></i>
                    Hapus PlayList</button>
        </li>
    </ul>
</div>
@include('admin.video._modalDelete')