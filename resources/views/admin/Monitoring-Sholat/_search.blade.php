<form class="w-full" action="{{ route('monitoring.sholat.index') }}" method="GET">
    ...
    <div class="flex border border-main3 rounded-lg focus:ring-0 focus:outline-none focus:border-main2 bg-white">
        <div class="relative w-full">
            ...
            <div class="relative">
                ...
                <input type="text" id="tagihanSearch" name="keyword"
        ...
        <button id="dropdown-button" data-dropdown-toggle="filter"
            ...
            @if (request('tahun') || request('jenjang'))
...
@include('admin.Monitoring-Sholat.modal-filter._modalTahunFilter')
@include('admin.Monitoring-Sholat.modal-filter._modalJenjangFilter')